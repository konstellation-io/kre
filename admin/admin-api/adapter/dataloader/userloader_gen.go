...
func (l *UserLoader) Load(key string) (*entity.User, error) {
...
func (l *UserLoader) LoadThunk(key string) func() (*entity.User, error) {
	l.mu.Lock()
...
func (l *UserLoader) LoadAll(keys []string) ([]*entity.User, []error) {
	results := make([]func() (*entity.User, error), len(keys))
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *UserLoader) LoadAllThunk(keys []string) func() ([]*entity.User, []error) {
	results := make([]func() (*entity.User, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *UserLoader) unsafeSet(key string, value *entity.User) {
	if l.cache == nil {
