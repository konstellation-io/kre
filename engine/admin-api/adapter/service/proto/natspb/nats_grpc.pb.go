...
const (
	NatsManagerService_CreateStreams_FullMethodName      = "/nats.NatsManagerService/CreateStreams"
	NatsManagerService_CreateObjectStores_FullMethodName = "/nats.NatsManagerService/CreateObjectStores"
	NatsManagerService_DeleteStreams_FullMethodName      = "/nats.NatsManagerService/DeleteStreams"
	NatsManagerService_DeleteObjectStores_FullMethodName = "/nats.NatsManagerService/DeleteObjectStores"
)
...
func (c *natsManagerServiceClient) CreateStreams(ctx context.Context, in *CreationRequest, opts ...grpc.CallOption) (*CreateStreamResponse, error) {
	...
	err := c.cc.Invoke(ctx, NatsManagerService_CreateStreams_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *natsManagerServiceClient) CreateObjectStores(ctx context.Context, in *CreationRequest, opts ...grpc.CallOption) (*CreateObjectStoreResponse, error) {
	...
	err := c.cc.Invoke(ctx, NatsManagerService_CreateObjectStores_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *natsManagerServiceClient) DeleteStreams(ctx context.Context, in *DeleteStreamsRequest, opts ...grpc.CallOption) (*DeleteResponse, error) {
	...
	err := c.cc.Invoke(ctx, NatsManagerService_DeleteStreams_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *natsManagerServiceClient) DeleteObjectStores(ctx context.Context, in *DeleteObjectStoresRequest, opts ...grpc.CallOption) (*DeleteResponse, error) {
	out := new(DeleteResponse)
	err := c.cc.Invoke(ctx, NatsManagerService_DeleteObjectStores_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _NatsManagerService_CreateStreams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NatsManagerService_CreateStreams_FullMethodName,
	}
...
func _NatsManagerService_CreateObjectStores_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NatsManagerService_CreateObjectStores_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _NatsManagerService_DeleteStreams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NatsManagerService_DeleteStreams_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _NatsManagerService_DeleteObjectStores_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NatsManagerService_DeleteObjectStores_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
