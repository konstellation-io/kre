...
func (UnimplementedVersionServiceServer) Stop(context.Context, *VersionName) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Stop not implemented")
}
func (UnimplementedVersionServiceServer) Publish(context.Context, *VersionName) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Publish not implemented")
}
func (UnimplementedVersionServiceServer) Unpublish(context.Context, *VersionName) (*Response, error) {
