...
const getSubtitle = {
  ...
  [STATES.SUCCESS]: 'Cras quis nulla commodo, aliquam lectus sed, blandit augue. Cras ullamcorper bibendum bibendum. ',
  [STATES.ERROR]: 'Cras quis nulla commodo, aliquam lectus sed, blandit augue. Cras ullamcorper bibendum bibendum. ',
};
const getCircleText = {
    ...
    <div className={ styles.bg }>
      <div className={ styles.grid }>
        <div className={ styles.container }>
          ...
          { status === STATES.ERROR && <div className={styles.errorText}>{error}</div> }
        </div>
      </div>
    </div>
  );
