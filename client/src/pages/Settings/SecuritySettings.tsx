...
import {GET_DOMAINS, ADD_ALLOWED_DOMAIN, REMOVE_ALLOWED_DOMAIN} from './dataModels';
...
function SecuritySettings() {
  ...
  const [addAllowedDomain] = useMutation(ADD_ALLOWED_DOMAIN, {onCompleted: onCompleteAddDomain});
  const [removeAllowedDomain] = useMutation(REMOVE_ALLOWED_DOMAIN, {onCompleted: onCompleteRemoveDomain});
