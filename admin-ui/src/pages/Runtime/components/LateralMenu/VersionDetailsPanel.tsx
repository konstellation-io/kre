...
import useVersionAction, { versionActions } from '../../utils/hooks';
...
function VersionDetailsPanel({
  ...
  return (
    <div className={styles.shield} onClick={closeVersionDetailsPanel}>
